window.feta = (function(document,$){
    ...
    [
        ...
        "focus",
        "keypress",
        //"change", TODO: this can cancel out click events, need to look into the best way to handle it
        "blur"
    ];
    ...
    return{
        ...
        getCurrentStack: function(){
            console.log("sending:",trackedEvents);
            return trackedEvents;
        },
        start: function (startWith){
            console.log("Starting with: ",startWith);
            trackedEvents=startWith || [];
        ...
        stop: function(cb,ret){
            ...
            for(var i=0;i<trackedEvents.length;i++){
                output += trackedEvents[i]+","; //outputEventRaw(trackedEvents[i])+",";
            }
        ...
        saveAsJS: function(report,cb,ret){
            ...
            for(var i=0;i<playlist.length;i++){
                ...
                reportAsJS += "\n\tif (evtelem.length === 0){ r.add('Element does not exist: "+evt.elem+"');}else{\n";
